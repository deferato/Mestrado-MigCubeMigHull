...
app2-s1:
	gcc -DAPP2 -DS1 migbsp.c -Wall -o migbsp -I /opt/simgrid/include/ -L /opt/simgrid/lib/ -l simgrid -lm

app2-s2:
	gcc -DAPP2 -DS2 migbsp.c -Wall -o migbsp -I /opt/simgrid/include/ -L /opt/simgrid/lib/ -l simgrid -lm

app2-s3:
	gcc -DAPP2 -DS3 migbsp.c -Wall -o migbsp -I /opt/simgrid/include/ -L /opt/simgrid/lib/ -l simgrid -lm
